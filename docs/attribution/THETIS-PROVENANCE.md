...
| src/core/SkuUiProfile.cpp | Project Files/Source/Console/setup.cs | 19832-20375; 6174; 6195; 6201-6273 | port | thetis-samphire | per-SKU label + checkbox visibility (RXAntChk1/2/3Name, Ext1/Ext2/RxOutOnTx, chkDisableRXOut) from switch(HardwareSpecific.Model) block; DH1KLM attribution tag preserved in REDPITAYA case |
| src/core/SkuUiProfile.h | Project Files/Source/Console/setup.cs | 19832-20375; 6174; 6195; 6201-6273 | port | thetis-samphire | header mirrors SkuUiProfile.cpp |
...
| src/core/TxChannel.cpp | Project Files/Source/wdsp/TXA.c; Project Files/Source/ChannelMaster/cmaster.c | 31-479; 177-190 | port | thetis-no-samphire | TXA 31-stage pipeline wrapper; stageRunning() reads txa[].stagename.p->run via extern struct _txa txa[]; null-guard for uninitialized channels; NR0V only (TXA.c + cmaster.c both Warren Pratt, no Samphire) |
| src/core/TxChannel.h | Project Files/Source/wdsp/TXA.c; Project Files/Source/ChannelMaster/cmaster.c | 31-479; 177-190 | port | thetis-no-samphire | Stage enum (31 ordinals + kStageCount=31 sentinel), stageRunning() declaration; all stage comments cite TXA.c line + [v2.10.3.13] stamp; NR0V only |
...
| src/gui/applets/TxCfcDialog.cpp | Project Files/Source/Console/frmCFCConfig.cs; Project Files/Source/Console/frmCFCConfig.Designer.cs | 217-583 [v2.10.3.13] | port | thetis-samphire | per-band CFC editor port — Phase 3M-3a-ii Batch 6 (Task A) modeless dialog; 10-row grid replaces Thetis's selected-band + edit pane (NereusSDR-spin per feedback_thetis_userland_parity); profile combo / Save / Save As / Delete mirror TxEqDialog A.2 |
| src/gui/applets/TxCfcDialog.h | Project Files/Source/Console/frmCFCConfig.cs; Project Files/Source/Console/frmCFCConfig.Designer.cs | 217-583 [v2.10.3.13] | port | thetis-samphire | dialog declaration; pairs with TxCfcDialog.cpp |
...
| src/models/TransmitModel.cpp | Project Files/Source/Console/console.cs | 12094; 1819-1820; 3087-3091; 4904-4910 | port | thetis-samphire | tunePower_by_band declaration (12094), init to 50W (1819-1820), save (3087-3091), restore (4904-4910); NereusSDR uses per-band scalar AppSettings keys instead of Thetis pipe-delimited string; per-MAC scope mirrors AlexController pattern (3M-1a G.3) |
| src/models/TransmitModel.h | Project Files/Source/Console/console.cs | 12094; 1819-1820; 3087-3091; 4904-4910 | port | thetis-samphire | header for tunePower_by_band G.3 additions; pairs with TransmitModel.cpp |
| tests/tst_alex_filter_map.cpp | Project Files/Source/Console/console.cs | 6830-6942; 7168-7234 | port | thetis-samphire | Alex HPF/LPF breakpoints regression — exercises AlexFilterMap with expected values lifted from console.cs |
