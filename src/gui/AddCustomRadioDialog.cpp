...
//
// Thetis field mapping:
//   txtSpecificRadio      → m_ipEdit + m_portSpin
//     Default "192.168.0.155:1024"           Designer.cs:64
//   comboProtocol         → m_protocolCombo
//     Items "Protocol 1" / "Protocol 2"      Designer.cs:81-82
//     SelectedIndex = 0 (P1 default)         frmAddCustomRadio.cs:60
//   txtBoard (ReadOnly)   → m_boardCombo (writable — expanded from Thetis)
//   comboNICS             → dropped (NereusSDR does not require NIC selection)
//
// NereusSDR additions beyond Thetis:
//   m_nameEdit      — user-friendly label for the saved entry
//   m_macEdit       — optional, enables Pin-to-MAC
//   m_pinToMacCheck — passed to AppSettings::saveRadio as pinToMac
//   m_autoConnectCheck — passed to AppSettings::saveRadio as autoConnect
//   Test button     — stub (unicast discovery probe deferred; real P1/P2
//                     probe via QUdpSocket requires NIC binding complexity
//                     out of scope for Task 16)
